...
function Meta() {
    ...
    return (
        <Helmet>
            {/* HTML Meta Tags */}
            <title>{data.name ? `${data.name} - Farjax Institute of Technology` : 'Farjax Institute of Technology'}</title>
            <meta name="description" content={data.shortDetails || 'The Farjax Institute of Technology is a training institute that provides training in various technology-related courses'} />

            {/* Facebook Meta Tags */}
            <meta property="og:url" content={data.name ? `https://www.farjaxit.com/course/${heading}` : 'https://www.farjaxit.com/'} />
            ...
            <meta property="twitter:url" content={data.name ? `https://www.farjaxit.com/course/${heading}` : 'https://www.farjaxit.com/'} />
            <meta name="twitter:title" content={data.name || 'Farjax Institute of Technology'} />
